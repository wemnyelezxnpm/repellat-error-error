[![Build Status](https://travis-ci.com/wemnyelezxnpm/repellat-error-error.svg?branch=main)](https://travis-ci.com/wemnyelezxnpm/repellat-error-error)
...
[![Maintainability](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/maintainability)](https://codeclimate.com/github/wemnyelezxnpm/repellat-error-error/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/test_coverage)](https://codeclimate.com/github/wemnyelezxnpm/repellat-error-error/test_coverage)
...
Install it using npm: `npm install @wemnyelezxnpm/repellat-error-error`

If used in a browser environment, you will need to manually install the local you wish to support.

```javascript
var languages = require("@wemnyelezxnpm/repellat-error-error");

// Support german & english languages.
languages.registerLocale(require("@wemnyelezxnpm/repellat-error-error/langs/en.json"));
languages.registerLocale(require("@wemnyelezxnpm/repellat-error-error/langs/de.json"));
```
